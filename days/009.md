...
3. Let's open the `requirements.txt` file in editor and update accordingly:
...
- To write conditional logic:

    ```txt
    {% if cookiecutter.variable_name == 'value' %}
    # content for this condition
    {% elif cookiecutter.variable_name == 'another_value' %}
